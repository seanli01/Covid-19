...
when not matched by target
	then insert (DateKey, CountryKey, TotalCases)
	values (s.Datekey, s.CountryKey, s.TotalCases);


--INSERT INTO [covid].[dbo].FactCovid (DateKey, CountryKey, TotalCases)
--SELECT DateKey, CountryKey, TotalCases
--FROM #tempFact
