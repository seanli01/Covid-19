...
select Unpvt.date,Unpvt.Country, Unpvt.new_deaths
into #temp
from [covid].[dbo].stg_source_new_deaths c

unpivot (
new_deaths for Country in (
Afghanistan,
Albania,
Algeria,
Andorra,
...
when matched then update set
	t.NewDeaths = s.NewDeaths

when not matched by target
	then insert (NewDeaths)
	values (s.NewDeaths);
