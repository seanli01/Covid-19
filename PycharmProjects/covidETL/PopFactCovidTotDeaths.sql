...
select Unpvt.date,Unpvt.Country, Unpvt.total_deaths
into #temp
from [covid].[dbo].stg_source_total_deaths c

unpivot (
total_deaths for Country in (
Afghanistan,
Albania,
Algeria,
Andorra,
...
when matched then update set
	t.TotalDeaths = s.TotalDeaths

when not matched by target
	then insert (TotalDeaths)
	values (s.TotalDeaths);
